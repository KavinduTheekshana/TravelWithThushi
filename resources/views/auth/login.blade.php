                ...
                <div class="row g-0">
                    ...
                    <div
                        ...
                        <div class="card shadow-none auth-img-cover-login-top bg-transparent shadow-none rounded-0 mb-0">
                            <img src="{{ asset('backend/assets/images/merlin.jpg') }}" class="img-fluid auth-img-cover-login"
                                width="650" alt="" />
                        </div>
                                        ...
                                        <form method="POST" action="{{ route('login') }}" class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input id="email" type="email"
                                                    class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Enter Your Email Address"
